...
namespace dp2weixinWeb.ApiControllers
{
    public class LibBookController : ApiController
    {
        ...
        /// <returns></returns>
        public SubjectResult GetSubject(string weixinId, string libId)
        {
        ...
        public SubjectMsgResult GetSubjectMsg(string weixinId, string libId, string subject)
        {
            SubjectMsgResult result = new SubjectMsgResult();
            string strError = "";
