...
#endif
        /// <summary>
        /// 前端，也就是 chordinstaller.exe 的版本号
        /// </summary>
...
"chordinstaller_v1");
            ...
            else
            {
                ...
                using (Mutex mutex = new Mutex(true, "chordinstaller V1", out createdNew))
                {
                    if (createdNew)
                    {
...
http://www.cnblogs.com/riasky/p/3481795.html
    ...
    "将信息发送给开发者");
        ...
        static string GetExceptionText(Exception ex, string strType)
        {
            ...
            strError += "\r\nchordInstaller 版本: " + myAssembly.FullName;
    ...
    "将信息发送给开发者");
        ...
        static void CrashReport(string strText)
        {
            ...
            _messageBar.Text = "dp2Installer 出现异常";
